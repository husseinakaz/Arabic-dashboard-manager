        ...
        <div class="container-fluid main_block">
            ...
            <div class="main_container col-lg-9 col-md-8 col-sm-9 col-xs- pull-left">
                <div class="row main_container_head">
                    <h4><span class="glyphicon glyphicon-envelope"></span>ارسال رسالة جديده</h4>
                </div>

                <div class="row control_panal_body">
                    <!--Start Admin Panal Section Description-->
                    <p class="page_desc">ارسال رسالة جديدة من خلال المحرر ادناه</p>
                    <!--End Admin Panal Section Description-->


                    <div class="alert alert-success h5" role="alert">تم الارسال بنجاح</div>
                    ...
                    <div class="admin_index">
                        ...
                        <div class="panel panel-default site_info">
                            <div class="panel-heading text-right h4">ارسال رساله جديده</div>

                            <form action="" method="post">
                                <div class="form-group">
                                    <label for="msg_title">عنوان الرسالة</label>
                                    <input type="text" class="form-control" id="msg_title" placeholder="عنوان الرساله">
                                </div>
                                <div class="form-group">
                                    <label>المرسل اليهم</label>
                                    <select class="form-control">
                                        <option>جميع الاعضاء</option>
                                        <option>المشرفين</option>
                                        <option>المديرين</option>
                                    </select> 
                                </div>
                                <div class="form-group">
                                    <label for="topic_editor">المحتوي</label>
