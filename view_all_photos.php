            ...
            <div class="main_container  main_menu_open">
                ...
                <div class="home_pass hidden-xs">
                    <ul>
                        ...
                        <li class="bring_right"><a href="">البوم الصور</a></li>
                        <li class="bring_right"><a href="">عرض كل الصور</a></li>
                    </ul>
                </div>
                <!--/End system bath-->
                ...
                <div class="page_content">
                    <h1 class="heading_title">عرض كل الصور</h1>

                    <div class="wrap text-center">

                        <div class="photo img-rounded img-thumbnail">
