        ...
        <div class="container-fluid main_block">
            ...
            <div class="main_container col-lg-9 col-md-8 col-sm-9 col-xs- pull-left">
                ...
                <div class="row control_panal_body">
                    ...
                    <p class="page_desc">يمكنك إضافة قسم جديد الي موقعك من الحقول ادناه</p>
                        ...
                        <div class="panel panel-default site_info">
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sec_name" placeholder="اسم القسم">
                                </div>
                                <div class="form-group">
                                    <label for="sec_desc">وصف القسم</label>
                                    <textarea rows="5" class="form-control" id="sec_desc" placeholder="اوصف محتوي القسم فيما لا يتعدي ٧٠ حرف"></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="sec_logo">لوحو القسم</label>
                                    <input type="file" id="sec_logo">
                                </div>
